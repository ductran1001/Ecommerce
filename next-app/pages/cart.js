...
const ProductCart_1 = require("@/components/pages/Cart/ProductCart");
const CartSummary_1 = require("@/components/pages/Cart/CartSummary");
const react_redux_1 = require("react-redux");
const link_1 = __importDefault(require("next/link"));
const Cart = ({ dataCategories }) => {
    ...
    return (<Layout_1.Layout dataCategories={dataCategories}>
            <div className="bg-white flex flex-col gap-y-4">
                {cart.length === 0 ? (<div className="text-center py-8">
                    ...
                    </div>) : (<div className="px-6 lg:grid grid-cols-12 gap-6 items-start pb-16 pt-4">
                        <ProductCart_1.ProductCart />
                        <CartSummary_1.CartSummary />
                    </div>)}
            </div>
        </Layout_1.Layout>);
};
