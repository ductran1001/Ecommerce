...
export const createCategorySchema = Yup.object().shape({ name, description });
...
export const productSchema = Yup.object().shape({ name, price, description, quantity, promotion });
