...
export const UpdateProduct = () => {
    ...
    const mutationUpdate = useMutation({
        mutationFn: (body: Apis.IFormProduct) => Apis.updateProduct(id as string, body),
    });
    ...
    const queryProduct = useQuery({
        queryKey: ['product', id],
        queryFn: () => Apis.getProductById(id as string),
        enabled: id !== undefined,
        onSuccess: (data) => {
            setColorSelect((prevState) => [...prevState, ...data.data.contents.color]);

            setProduct((prevState) => ({ ...prevState, ...data.data.contents }));
        },
    });
    ...
    if (queryProduct.error) return Layouts.Error((queryProduct.error as AxiosError).message);
                        ...
                        <div className="w-full px-4 py-8 mx-auto space-y-6 border lg:w-4/5 sm:px-6 md:px-8 lg:px-10">
                                ...
                                <div className="flex items-center">
                                    ...
                                    {queryColors.error ? (
                                        <div className="text-red-500">
                                            An error has occurred: {(queryColors.error as AxiosError).message}
                                        </div>
                                    ) : (
                                        colors.length > 0 && (
                                            <select
                            ...
                            <div className="flex flex-col">
                                <div className="flex items-center">
                                    ...
                                    {queryBrands.error ? (
                                        <div className="text-red-500">
                                            An error has occurred: {(queryBrands.error as AxiosError).message}
                                        </div>
                                    ) : (
                                        brands.length > 0 && (
                                            <select
                            ...
                            <div className="flex flex-col">
                                <div className="flex items-center">
                                    ...
                                    {queryCategories.error ? (
                                        <div className="text-red-500">
                                            An error has occurred: {(queryCategories.error as AxiosError).message}
                                        </div>
                                    ) : (
                                        categories.length > 0 && (
                                            <select
