...
const CreateProduct = () => {
    ...
    const mutationCreate = (0, react_query_1.useMutation)({ mutationFn: (body) => Apis.createProduct(body) });
    ...
    const isLoad = queryCategories.isLoading || mutationCreate.isLoading || queryColors.isLoading || queryBrands.isLoading;
                            ...
                            <div className="flex flex-col">
                                <div className="flex items-center">
                                    ...
                                    {queryColors.error ? (<div className="text-red-500">
                                            ...
                                            {queryColors.error.message}
                                        </div>) : (colors.length > 0 && (<select defaultValue={(_a = product.color[0]) !== null && _a !== void 0 ? _a : 'DEFAULT'} name="color" className="pl-4 flex-1 focus:outline-none bg-gray-50 border border-gray-300 text-gray-900 rounded-lg block w-full p-2.5" onChange={(event) => handleInputChangeColor(event)}>
                            ...
                            <div className="flex flex-col">
                                <div className="flex items-center">
                                    ...
                                    {queryBrands.error ? (<div className="text-red-500">
                                            An error has occurred:
                                            {queryBrands.error.message}
                                        </div>) : (brands.length > 0 && (<select defaultValue={(_b = product.brand) !== null && _b !== void 0 ? _b : ''} name="brand" className="pl-4 flex-1 focus:outline-none bg-gray-50 border border-gray-300 text-gray-900 rounded-lg block w-full p-2.5" onChange={(event) => handleInputChange(event)}>
                            ...
                            <div className="flex flex-col">
                                <div className="flex items-center">
                                    ...
                                    {queryCategories.error ? (<div className="text-red-500">
                                        ...
                                        </div>) : (categories.length > 0 && (<select defaultValue={(_c = product.category) !== null && _c !== void 0 ? _c : ''} name="category" className="pl-4 flex-1 focus:outline-none bg-gray-50 border border-gray-300 text-gray-900 rounded-lg block w-full p-2.5" onChange={(event) => handleInputChange(event)}>
