            ...
            <div className="pb-8">
                <div className="flex items-center gap-12">
                    <div className="flex items-center gap-2">
                        <Link to="/admin/products/create" className="flex items-center w-12 h-12">
                        ...
                        <div className="flex items-center justify-center w-40  text-blue-500 border border-gray-200">
                            {softDelete ? (
                                <button onClick={() => handleRestoreMulti(checked)} className="uppercase py-3">
                                    restore items
                                </button>
                            ) : (
                                <Link to="/admin/products/trash" className="uppercase py-3">
                                    trash items
                                </Link>
                            )}
                        </div>
                    ...
                    <div className="flex gap-2">
                        <div className=" flex items-center">
                            <select
                                ...
                                className="w-44 text-sm text-gray-600 px-4 py-3 border-gray-300 shadow-sm rounded focus:ring-primary focus:border-primary focus:outline-none"
                            >
                                ...
                                <th scope="col" className="p-4">
                                    <div className="flex items-center">
                                        <input
                                            onChange={(event) =>
                                                handleCheckboxAll(
                                                    [...response?.contents.map((product) => product._id)],
                                                    event
                                                )
                                            }
                                            className="pl-10"
                                            checked={
                                                response?.contents.length === checked.length &&
                                    ...
                                    <tr key={index} className="border-b hover:bg-gray-50">
                                        ...
                                        <td className="gap-2 px-6 py-4">
                                            <div className="flex items-center mb-2">
                                                <Link
                                                    to={`/admin/products/update/${pro._id}`}
