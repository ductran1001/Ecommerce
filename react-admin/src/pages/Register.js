...
const Register = () => {
    ...
    const { register, handleSubmit, formState: { errors, isDirty, isValid }, } = (0, react_hook_form_1.useForm)({
        resolver: (0, yup_1.yupResolver)(Utils.registerSchema),
        mode: 'onChange',
    ...
    const mutationRegister = (0, react_query_1.useMutation)({ mutationFn: (body) => Apis.registerUser(body) });
    return (<div className="flex flex-col items-center justify-center min-h-screen">
            ...
            <div className="flex flex-col w-full max-w-md px-4 py-8 bg-white rounded-md shadow-md sm:px-6 md:px-8 lg:px-10">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <div className="flex flex-col mb-6">
                            ...
                            <div className="relative">
                                ...
                                <input {...register('fullName')} className="pl-10" type="text" name="fullName" placeholder="John Doe"/>
                            </div>
                            <div className="flex w-full">
                                {(errors === null || errors === void 0 ? void 0 : errors.fullName) && (<p className="w-full mt-2 text-sm italic text-red-600 capitalize">
                        ...
                        <div className="flex w-full">
                            <button disabled={!isDirty || !isValid} type="submit" className="flex items-center justify-center w-full py-2 text-sm text-white transition duration-150 ease-in bg-blue-600 rounded focus:outline-none sm:text-base hover:bg-blue-700">
                ...
                <div className="flex items-center justify-center mt-6">
                    <react_router_dom_1.Link to="/admin/login" className="inline-flex items-center text-sm font-bold text-center text-blue-500 hover:text-blue-700">
