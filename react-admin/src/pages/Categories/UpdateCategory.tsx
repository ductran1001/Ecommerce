...
export const UpdateCategory = () => {
    ...
    const [category, setCategory] = React.useState<IFormCategory>(Utils.initialStateCategoryForm);
    ...
    const queryCategory = useQuery({
        ...
        onSuccess: (data) => {
            setCategory((prevState) => ({ ...prevState, ...data.data.contents }));
        },
    });

    if (queryCategory.error) return Layouts.Error((queryCategory.error as AxiosError).message);
