    ...
    const query = useQuery({
        ...
        queryFn: () =>
            softDelete
                ...
                : Apis.getListCategories(PAGE as number, LIMIT),
        ...
        <div className="flex flex-col h-full gap-8 px-4 pt-12">
            ...
            <div className="pb-8">
                <div className="flex items-center gap-2">
                    <Link to="/admin/categories/create" className="flex items-center w-12 h-12">
                    ...
                    <div className="flex items-center justify-center w-40 h-16 text-blue-500 border border-gray-200">
                        {softDelete ? (
                            ...
                            <Link to="/admin/categories/trash" className="uppercase">
                                trash items
                            </Link>
                        )}
                    </div>
                ...
                <div className="w-full my-8 overflow-x-auto">
                    <table className="w-full text-left text-gray-500 bg-white shadow-md sm:rounded-lg">
                                ...
                                <th scope="col" className="p-4">
                                    <div className="flex items-center">
                                        <input
                                            onChange={(event) =>
                                                handleCheckboxAll(
                                                    [...response?.contents.map((cate) => cate._id)],
                                                    event
                                                )
                                            }
                                            className="pl-10"
                        ...
                        <tbody>
                            {response &&
                                response.contents.map((category, index) => (
